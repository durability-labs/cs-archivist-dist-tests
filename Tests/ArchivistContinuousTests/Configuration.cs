...
namespace ContinuousTests
{
    public class Configuration
    {
        ...
        [Uniform("archivist-deployment", "c", "ARCHIVISTDEPLOYMENT", true, "Path to archivist-deployment JSON file.")]
        public string ArchivistDeploymentJson { get; set; } = string.Empty;
        ...
        public ArchivistDeployment ArchivistDeployment { get; set; } = null!;
    }
    ...
    public class ConfigLoader
    {
        public Configuration Load(string[] args)
        {
            ...
            result.ArchivistDeployment = ParseArchivistDeploymentJson(result.ArchivistDeploymentJson);
            return result;
        }
        
        private ArchivistDeployment ParseArchivistDeploymentJson(string filename)
        {
            var d = JsonConvert.DeserializeObject<ArchivistDeployment>(File.ReadAllText(filename))!;
        ...
        private static void PrintHelp()
        {
            ...
            Console.WriteLine("ContinuousTests will run a set of tests against a archivist deployment given a archivist-deployment.json file." + nl +
