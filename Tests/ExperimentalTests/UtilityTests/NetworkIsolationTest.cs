...
namespace ExperimentalTests.UtilityTests
{
    ...
    {
        private IArchivistNode? node = null;

        [Test]
        public void SetUpANodeAndWait()
        {
            node = Ci.StartArchivistNode();
        ...
        {
            var myNode = Ci.StartArchivistNode();
            ...
            Assert.Fail("Connection could be established between two Archivist nodes running in different namespaces. " +
