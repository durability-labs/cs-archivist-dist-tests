...
{
    public interface IArchivistInstance
    {
        string Name { get; }
    ...
    public class ArchivistInstance : IArchivistInstance
    {
        public ArchivistInstance(string name, string imageName, DateTime startUtc, Address discoveryEndpoint, Address apiEndpoint, Address listenEndpoint, EthAccount? ethAccount, Address? metricsEndpoint)
        {
            Name = name;
            ImageName = imageName;
            StartUtc = startUtc;
        ...
        public static IArchivistInstance CreateFromApiEndpoint(string name, Address apiEndpoint, EthAccount? ethAccount = null)
        {
