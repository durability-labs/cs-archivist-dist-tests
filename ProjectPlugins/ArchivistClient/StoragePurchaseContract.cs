...
namespace ArchivistClient
{
    ...
    public class StoragePurchaseContract : IStoragePurchaseContract
    {
        ...
        public StoragePurchaseContract(ILog log, ArchivistAccess archivistAccess, string purchaseId, StoragePurchaseRequest purchase, IArchivistNodeHooks hooks)
        {
            this.log = log;
        ...
        private void WaitForStorageContractState(TimeSpan timeout, StoragePurchaseState desiredState, int sleep = 1000)
        {
            ...
            while (lastState != desiredState)
            {
                ...
                var purchaseStatus = archivistAccess.GetPurchaseStatus(PurchaseId);
