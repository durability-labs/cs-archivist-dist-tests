...
namespace ArchivistPlugin.OverwatchSupport
{
    ...
    {
        public ArchivistNodeIdentity[] DeterminePositions(ArchivistNodeIdentity[] identities)
        {
        ...
        private Dictionary<ArchivistNodeIdentity, BigInteger>  CalculateDistances(ArchivistNodeIdentity zero, ArchivistNodeIdentity[] identities)
        {
            var result = new Dictionary<ArchivistNodeIdentity, BigInteger>();
        ...
        private void CalculateNormalizedPositions(Dictionary<ArchivistNodeIdentity, BigInteger> distances, BigInteger maxDistance)
        {
