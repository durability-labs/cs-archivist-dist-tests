...
{
    [Serializable]
    public class OverwatchArchivistHeader
    {
        public ArchivistNodeIdentity[] Nodes { get; set; } = Array.Empty<ArchivistNodeIdentity>();
    }

    [Serializable]
    public class OverwatchArchivistEvent
    {
    ...
    [Serializable]
    public class ArchivistNodeIdentity
    {
    ...
    #region Archivist Generated Events
