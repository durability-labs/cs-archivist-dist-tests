...
{
    public class ArchivistContainerProcessControl : IProcessControl
    {
        ...
        public ArchivistContainerProcessControl(IPluginTools tools, RunningPod pod, Action onStop)
        {
            this.tools = tools;
            this.pod = pod;
            this.onStop = onStop;
        ...
        public void DeleteDataDirFolder()
        {
            ...
            try
            {
                var dataDirVar = container.Recipe.EnvVars.Single(e => e.Name == "ARCHIVIST_DATA_DIR");
                var dataDir = dataDirVar.Value;
                var workflow = tools.CreateWorkflow();
                workflow.ExecuteCommand(container, "rm", "-Rfv", $"/archivist/{dataDir}/repo");
