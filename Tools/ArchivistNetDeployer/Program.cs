...
using Configuration = ArchivistNetDeployer.Configuration;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("ArchivistNetDeployer" + nl);
    ...
    {
        var nl = Environment.NewLine;
        Console.WriteLine("ArchivistNetDeployer allows you to deploy multiple Archivist nodes in a Kubernetes cluster. " +
            "The deployer will set up the required supporting services, deploy the Archivist on-chain contracts, start and bootstrap the Archivist instances. " +
